<template>
<section class="h-screen bg-[#173467]">
  <div class="px-6 h-full text-gray-800">
    <div class="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
      <div class="grow-0 shrink-1 md:shrink-0 basis-auto xl:w-6/12 lg:w-6/12 md:w-9/12 mb-12 md:mb-0">
        <img src="https://res.cloudinary.com/guidedsteps/image/upload/v1648757070/white_vertical_guidedsteps_v4_color_mark_text_copy.svg" class="w-full" alt="Sample image"/>
      </div>
      <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
        <form>
          <div class="flex flex-row items-center justify-center lg:justify-start">
            <p class="text-lg text-white font-bold mb-0 mr-4">Sign in with</p>
